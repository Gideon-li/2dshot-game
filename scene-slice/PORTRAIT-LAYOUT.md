...
- **Look 偏移（相对 CLINIC-CONSULT-V139；L3 平板透视实测，看图优先）**：
  - 锁表 Desk/PhysicianChair/PatientChair/Bench 节点落在**桌面/椅背/抽屉**，不可当脚底。
  - 江晚 **(1220, 1000)** 显示高≈320 — 凳脚向椅腿/桌下地面带（禁 655 悬空）。
  - 坐诊病患 **(1280, 1240)** — 桌前南侧地面，ΔY≥120 对坐。
  - 候诊 A–D **右过道地面** (1920,1280)/(2060,1270)/(1800,1300)/(2180,1260)；脚远离桌面。
  - Idle：HERO nudge (1280,820) zoom≈0.48；开诊 CAM_ASK (1260,1140) zoom≈0.62。
  - **L3 平板极限**：无桌沿遮挡层时，椅后角色仍会叠画桌；场景锁若要真「椅后对坐」，需补 `L3_desk_front` Y-sort 遮挡或重锚 PhysicianChair→画里椅腿地面并拆桌前层。
