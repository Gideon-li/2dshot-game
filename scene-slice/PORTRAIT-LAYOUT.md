...
- **Look 偏移（相对 CLINIC-CONSULT-V139；L3 透视/柜面错读，看图优先）**：
  - 江晚 **(1090, 655)** — 落在画中椅背/桌后（锁节点 1035,770 会读成压桌面）；`APPRENTICE_HOME_LOCK` 仍保留锁值。
  - 候诊 A–D 改到**右侧走道** ≈(1480,980)/(1600,975)/(1380,1000)/(1720,970)（锁左凳 Y≈400 贴左柜抽屉；现 x>1320 在作业区东侧外）。
  - 坐诊病患仍 **(1040, 590)**。
  - Idle zoom ≈0.55 @ HERO (1280,780)；开诊验收可用 CAM_ASK (1100,640) zoom≈0.85 拍双人。
  - 药壶/脉枕/香炉：底对齐钉桌面，`FootShadow` 辅助接地；L4 全幅合图保持隐藏。
